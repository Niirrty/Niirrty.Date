...
class Time implements IStringable, IArrayable, \Serializable
{
    ...
    * @return \Niirrty\Date\Time
    * @throws \Niirrty\ArgumentException If $value is lower than 0 or bigger than 86399.
    */
    ...
    * @return \Niirrty\Date\Time Returns the current changed instance.
    * @throws \Niirrty\ArgumentException If resulting time is bigger than 23:59:59 or lower than 00:00:00
    */
    ...
    * @return \Niirrty\Date\Time|bool Returns the created Time instance, or boolean FALSE if parsing fails.
    */
    ...
    *
    * @param  mixed $timeDefinition The value to parse as Time. It can be a (date) time string, a unix timestamp, a
    *                               object of type \Niirrty\DateTime or \DateTime or something that can be converted, by
